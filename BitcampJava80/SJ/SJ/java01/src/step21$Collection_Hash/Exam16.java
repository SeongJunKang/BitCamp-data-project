...
public class Exam16 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // Set<Map.Entry<String,Member>> entrySet = map.entrySet();     // 리턴값 : [키- 값]의 목록
    // // entrySet에 들어있는 객체들은 Entry 타입의 객체이다.
    // // -> entry타입이 java.util. 패키지에 있는지 찾아보라
    // // -> Map 인터페이스의 중첩 인터페이스이다.
    // // Set에 어떤 타입의 객체가 들어있는지 선언 했기 때문에.
    // // 다음과 같이 변수의 타입으로 Map.Entry를 사용할 수 있다.
    // for(Map.Entry<String,Member> entry : entrySet) {
    //   // 위와 같이 항목의 타입을 정확히 지정하면,
    //   // 그 타입의 메소드를 마음놓고 사용할 수
