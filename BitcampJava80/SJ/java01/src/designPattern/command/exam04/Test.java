 ...
 * 상속 ?
 * - 계속 기능이 추가될 떄 마다 서브 클래스를 만든다면,
 *   너무 많은 서브 클래스가 생성되는 문자가 발생
 * 
 * 해결책 ?
 * - 메서드를 작은 클래스 단위로 쪼개어 정의
...
public class Test {
  ...
  public static void main(String[] args) {
      ...
      commandMap.get(args[1]).execute(Integer.parseInt(args[0]), Integer.parseInt(args[2]));
