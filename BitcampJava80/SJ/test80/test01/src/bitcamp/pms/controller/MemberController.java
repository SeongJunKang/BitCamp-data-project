...
//
//    System.out.print("이름? ");
//    member.setNm(keyScan.nextLine());
//
//    System.out.print("이메일? ");
//    member.setEmail(keyScan.nextLine());
//
//    System.out.print("암호? ");
//    member.setPwd(keyScan.nextLine());
//
//    System.out.print("전화? ");
...
//  }
    ...
    try {
      ...
      for (Member member : members) {
        System.out.printf("%d, %s, %s, %s\n", member.getMemd(),
            member.getNm(), member.getEmail(), member.getTel());
      }
    } catch (Exception e) {
  ...
  public void update(Scanner keyScan) {
    try {
      ...
      System.out.printf("이름(%s)? ", member.getNm());
      member.setNm(keyScan.nextLine());

      System.out.printf("이메일(%s)? ", member.getEmail());
      member.setEmail(keyScan.nextLine());

      System.out.printf("암호(%s)? ", member.getPwd());
      member.setPwd(keyScan.nextLine());
