...
public class Servlet34 extends HttpServlet {
  ...
  protected void service(
    ...
    out.println("쿠키 받았음! servlet 34<br>");
...
/* 
# /1/2/3/servlet34 에서 받을 수 있는 쿠키
- name2(/)

# HTTP 요청 프로토콜과 쿠키 => 쿠키가 없음.
GET /web02/1/2/3/servlet34 HTTP/1.1
Host: localhost:8080
...
Cookie: name2=%EA%B2%BD%EB%A1%9C%3A%EB%AA%A8%EB%93%A0
 */
