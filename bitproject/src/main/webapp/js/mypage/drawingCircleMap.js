        ...
        var lnt = sessionStorage.getItem("lnt");
        var rad = sessionStorage.getItem("rad");
        if(lat) {
            var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
              ...
              var circle = new daum.maps.Circle({
                center : new daum.maps.LatLng(lat, lnt, 17), // 원의 중심좌표 입니다 
   ...
   function ex_map() {
    window.open('../img/resist/map.gif','지도 설정 설명','width=960, height=355,location=no,resizable=no, scrollbars=no');
   }
