(function($, moment)
{
	...
	function Plugin(element, options)
	{
		...
		this.params = { date : true, time : true, format : 'YYYY-MM-DD', minDate : null, maxDate : null, currentDate : null, lang : 'ko', weekStart : 0, shortTime : false, 'cancelText' : '취소', 'okText' : '확인' };
										...
										'<div class="dtp-picker">' +													
											...
											'<div class="dtp-picker-datetime hidden">' +
												'<div class="dtp-actual-meridien">' +
													'<div class="left p20">' +
														'<a class="dtp-meridien-am" href="javascript:void(0);">오전</a>' +
													'</div>' +
													'<div class="dtp-actual-time p60"></div>' +
													'<div class="right p20">' +
														'<a class="dtp-meridien-pm" href="javascript:void(0);">오후</a>' +
													'</div>' +
													'<div class="clearfix"></div>' +
												'</div>' +
